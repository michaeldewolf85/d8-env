...
sed -i 's/\tindex.*;/\tindex index.php index.html index.htm;/g' "/etc/nginx/sites-available/$HOSTNAME"
sed -i 's/\ttry_files.*;/\ttry_files $uri $uri/ /index.php;/g' "/etc/nginx/sites-available/$HOSTNAME"
